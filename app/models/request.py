...
class OCRResponse(BaseModel):
    ...
    college: Optional[str] = Field(None, description="Name of the college or educational institution")
    # requestor_name: Optional[str] = Field(None, description="Full name of the requestor")
    federal_tax_classification: Optional[str] = Field(None, description="Federal tax classification (e.g., Individual, Corporation, etc.)")
    exempt_payee_code: Optional[str] = Field(None, description="Exempt payee code if applicable")
    fatca_reporting_code: Optional[str] = Field(None, description="FATCA reporting code if applicable")
    address: Optional[str] = Field(None, description="Street address of the individual or entity")
    city_state_zip: Optional[str] = Field(None, description="City, state, and ZIP code combined")
    social_security_number: Optional[str] = Field(None, description="Social Security Number (SSN), if provided")
